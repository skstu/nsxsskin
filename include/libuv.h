...
namespace libuv {
	...
	public:
		...
		virtual void Release() const = 0;
		virtual SessionStatus Status() const { return SessionStatus::UNKNOWN; }
		virtual bool Write(const unsigned long&, const IBuffer*) { return false; }
		virtual bool Write(const unsigned long&, const char*, size_t) { return false; }
		virtual ServerType ServerTypeGet() const { return ServerType::UNKNOWN; }
		virtual SessionType SessionTypeGet() const { return SessionType::UNKNOWN; }
		virtual AddressType AddressTypeGet() const { return AddressType::UNKNOWN; }
		virtual size_t SessionCount() const { return 0; }
	};

	class IServiceManager : public IModule {
	public:
		class IConfig : public IModule::IConfig {
		public:
			using tfOnServerErrorCb = void(*)(const ISession*, const SystemErrorno&, const IBuffer*);
			...
			using tfOnServerHelloCb = void(*)(const ISession*, const IBuffer*, IBuffer*);
			...
			using tfOnServerSessionTimeoutCb = void(*)(const ISession*, const std::time_t&);
			...
			using tfOnServerKeepAliveCb = void(*)(const ISession*, const IBuffer*, IBuffer*);
			using tfOnServerMessageCb = void(*)(const ISession*, const CommandType&, const IBuffer*);
			using tfOnServerMessageReceiveReply = void(*)(const ISession*, const CommandType&, const IBuffer*, CommandType&, IBuffer*);
			using tfOnClientWelcomeCb = void(*)(const IBuffer*/*welcome*/, IBuffer*/*hello*/);
			using tfOnClientForceCloseCb = void(*)(const ISession*);
			using tfOnClientMessageCb = void(*)(const ISession*, const CommandType&, const IBuffer*);
			using tfOnClientMessageReceiveReply = void(*)(const ISession*, const CommandType&, const IBuffer*, CommandType&, IBuffer*);
		...
		public:
			...
			virtual void RegisterServerSessionCreateCb(const tfOnServerSessionCreateCb&) = 0;
			virtual void RegisterServerSessionDestroyCb(const tfOnServerSessionDestroyCb&) = 0;
			virtual void RegisterServerSessionAcceptCb(const tfOnServerSessionAcceptCb&) = 0;
			virtual void RegisterServerSessionReadyCb(const tfOnServerSessionReadyCb&) = 0;
			virtual void RegisterServerSessionTimeoutCb(const tfOnServerSessionTimeoutCb&) = 0;
			virtual void RegisterClientWelcomeCb(const tfOnClientWelcomeCb&) = 0;
			virtual void RegisterServerSessionWriteHookCb(const tfOnHookServerSessionWriteCb&) = 0;
			...
			virtual void RegisterServerMessageReceiveReplyCb(const tfOnServerMessageReceiveReply&) = 0;
			virtual void RegisterServerWelcomeSendHookCb(const tfOnHookServerWelcomeSendCb&) = 0;
			...
			virtual void RegisterClientMessageReceiveReplyCb(const tfOnClientMessageReceiveReply&) = 0;
			...
			virtual void RegisterClientSessionWriteHookCb(const tfOnHookClientSessionWriteCb&) = 0;
		};
	public:
