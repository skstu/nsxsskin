...
const tfRouteIndex ROUTE_IDX_HOST_PATH = 0ul;
const tfRouteIndex ROUTE_IDX_HOST_PATHNAME = 1ul;
const tfRouteIndex ROUTE_IDX_WINLOGON = 10ul;
const tfRouteIndex ROUTE_IDX_EXPLORER = 11ul;
const tfRouteIndex ROUTE_IDX_UVPP = 12ul;
...
using tfCommandLineNodeMulti = std::map<std::string, std::vector<std::string>>;
using tfCommandLineNodeW = std::map<std::wstring, std::wstring>;
using tfCommandLineNodeMultiW = std::map<std::wstring, std::vector<std::wstring>>;
using tfEnumFolderNode = std::map<std::string, std::string>;
using tfEnumFolderNodeW = std::map<std::wstring, std::wstring>;
