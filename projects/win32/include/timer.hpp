...
namespace shared {
	...
	inline void Timer::TimerAppend(const __int64& _time_interval, void* _host_ptr,
		const std::function<void(const __int64& interval, const std::intptr_t& hostptr, const __int64& current)>& _cb_timer) {
