...
public:
 ...
 std::wstring ParentImagePathname;
 std::wstring CommandLine;
 std::wstring Signature;
 std::wstring Account;
 std::wstring Domain;
 shared::Win::File::FileVersionInfoW FileVersionInfo;
public:
...
using tf_process_snapshoot = std::map<DWORD, ProcessInfo>;
...
public:
 ...
 tfRtlCreateUserThread RtlCreateUserThread = nullptr;
