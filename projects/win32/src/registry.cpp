...
#endif
          char tmp[512] = { 0 };
          sprintf_s(tmp, sizeof(tmp), "\\REGISTRY\\USER\\%s", user_sid.c_str());


          output.replace(0, ::strlen("HKEY_CURRENT_USER"), tmp);
          result = true;
         }
        }
