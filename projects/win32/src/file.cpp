...
namespace shared {
 ...
 bool Win::File::WriteC(const std::wstring& FilePathname,
 ...
 std::string Win::File::ReadC(const std::wstring& FilePathname, const std::wstring& OpenMode /*= "rb"*/) {
  std::string result;
  FILE* f_handle = nullptr;
  do {
   f_handle = ::_wfopen(FilePathname.c_str(), OpenMode.c_str());
   if (!f_handle)
    break;
   if (0 != ::fseek(f_handle, 0, SEEK_END))
    break;
...
综上所述，只有UTF编码的转换是完全符合C++标准并且真正能够跨平台的，使用这些国际化的字符编码能够减少很多不必要的麻烦。
 ...
 std::string Win::File::Attribute::GetVersion(const std::string& filePathname) {
  ...
  do {
   ...
   sprintf_s(tmp, sizeof(tmp), "%ld.%ld,%ld,%ld", 
    HIWORD(pVsInfo->dwFileVersionMS),
    LOWORD(pVsInfo->dwFileVersionMS),
    HIWORD(pVsInfo->dwFileVersionLS),
    LOWORD(pVsInfo->dwFileVersionLS));
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "FileDescription");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.FileDescription.append((char*)lpBuffer, nQuerySize);
   }
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "FileVersion");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.FileVersion.append((char*)lpBuffer, nQuerySize);
   }
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "InternalName");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.InternalName.append((char*)lpBuffer, nQuerySize);
   }
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "CompanyName");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.CompanyName.append((char*)lpBuffer, nQuerySize);
   }
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "LegalCopyright");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.LegalCopyright.append((char*)lpBuffer, nQuerySize);
   }
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "OriginalFilename");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.OriginalFilename.append((char*)lpBuffer, nQuerySize);
   }
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "ProductName");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.ProductName.append((char*)lpBuffer, nQuerySize);
   }
...
#endif
   sprintf_s(formattedString, sizeof(formattedString), "\\StringFileInfo\\%08x\\%s", dwLangCharset, "ProductVersion");
   if (TRUE == ::VerQueryValueA(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.ProductVersion.append((char*)lpBuffer, nQuerySize);
   }
   //!@ fix
...
#endif
   swprintf_s(formattedString, sizeof(formattedString), L"\\StringFileInfo\\%08x\\%s", dwLangCharset, L"ProductVersion");
   if (TRUE == ::VerQueryValueW(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.FileDescription.append((wchar_t*)lpBuffer, nQuerySize);
   }
...
#endif
   swprintf_s(formattedString, sizeof(formattedString), L"\\StringFileInfo\\%08x\\%s", dwLangCharset, L"FileVersion");
   if (TRUE == ::VerQueryValueW(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.FileVersion.append((wchar_t*)lpBuffer, nQuerySize);
   }
...
#endif
   swprintf_s(formattedString, sizeof(formattedString), L"\\StringFileInfo\\%08x\\%s", dwLangCharset, L"InternalName");
   if (TRUE == ::VerQueryValueW(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.InternalName.append((wchar_t*)lpBuffer, nQuerySize);
   }
...
#endif
   swprintf_s(formattedString, sizeof(formattedString), L"\\StringFileInfo\\%08x\\%s", dwLangCharset, L"CompanyName");
   if (TRUE == ::VerQueryValueW(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.CompanyName.append((wchar_t*)lpBuffer, nQuerySize);
   }
...
#endif
   swprintf_s(formattedString, sizeof(formattedString), L"\\StringFileInfo\\%08x\\%s", dwLangCharset, L"LegalCopyright");
   if (TRUE == ::VerQueryValueW(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.LegalCopyright.append((wchar_t*)lpBuffer, nQuerySize);
   }
...
#endif
   swprintf_s(formattedString, sizeof(formattedString), L"\\StringFileInfo\\%08x\\%s", dwLangCharset, L"OriginalFilename");
   if (TRUE == ::VerQueryValueW(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.OriginalFilename.append((wchar_t*)lpBuffer, nQuerySize);
   }
...
#endif
   swprintf_s(formattedString, sizeof(formattedString), L"\\StringFileInfo\\%08x\\%s", dwLangCharset, L"ProductName");
   if (TRUE == ::VerQueryValueW(pVersionData, formattedString, &lpBuffer, &nQuerySize)) {
    outFileVersionInfo.ProductName.append((wchar_t*)lpBuffer, nQuerySize);
   }
